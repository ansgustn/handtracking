...
* 1. 환경 설정
* 카메라 환경 : 물체에서 40cm 카메라 각도 45도 -45도(Azure Kinect DK Depth Camera 2대 사용) 정면 웹캠을 활용하였습니다.
* 물체 : 종이컵으로 실험을 진행 하였으며(나사와 비슷한 환경설정) 세로,가로,정면 으로 다양한 실험을 하였습니다.
* 측정 각도 : 90, 180, 270, 360
